#
#  Be sure to run `pod spec lint LiveKnob.podspec' to ensure this is a
...
You can change the line width and color of the base ring, progress ring and pointer.   Also you can tweak the start and end angles of the base knob ring.
  ...
  s.homepage     = "https://github.com/cemolcay/LiveKnob"
  ...
  s.source       = { :git => "https://github.com/cemolcay/LiveKnob.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "LiveKnob/LiveKnob.swift"
